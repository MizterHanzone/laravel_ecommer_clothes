                ...
                <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="pname">
                                <div class="image">
                                    <img src="{{asset('uploads/products/thumbnail')}}/{{$orderitem->product->image}}" alt="" class="image">
                                </div>
                                <div class="name">
                                    <a href="{{route('shop.product_details',["product_slug"=>$orderitem->product->slug])}}" target="_blank" class="body-title-2">{{$orderitem->product->name}}</a>                                    
                                </div>  
                            </td>
                            ...
                            <td class="text-center">
                                <a href="{{route('shop.product_details',["product_slug"=>$orderitem->product->slug])}}" target="_blank">
